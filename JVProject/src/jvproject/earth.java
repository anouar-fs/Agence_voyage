...
public class earth extends javax.swing.JFrame {
    ...
    public earth() {
        initComponents();
        jLabel1.setIcon(new ImageIcon(".\\pictures\\globe-44.gif"));
      ...
      public void setI(int i,Timer tm,Main_1 a) {
        this.i = (i+1);
        if(i>=100){ 
            tm.setRepeats(false);
            a.setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(1194, 674));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(193, 110, 5));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(earth.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
